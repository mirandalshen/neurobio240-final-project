...
def main():
    ...
    # Paths
    input_dir = f'/shared/home/mis6559/neurobio240/decoded/image-{method}/{subject}/samples/'
    outdir = f'/shared/home/mis6559/neurobio240/identification/{method}/{subject}/'
    ...
    print(f"Extracting features for {args.method}/{args.subject} ...")
