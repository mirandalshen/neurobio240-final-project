...
parser.add_argument("--input_dir", type=str, default=None, help="Optional: custom input feature directory")
...
# Paths
topdir = './nsdfeat/'
featdir = args.input_dir if args.input_dir else os.path.join(topdir, featname)
